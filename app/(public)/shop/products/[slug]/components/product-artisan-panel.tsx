      ...
      <div className={containerClass}>
        ...
        <article className="surface-card flex flex-col gap-5 p-6 sm:p-8">
          <p className="text-sm leading-7 text-foreground/80">
            This piece reflects the artisan’s ongoing dialogue between hand skill,
            local material memory, and practical use. Through exhibitions,
            workshops, and collaborative programmes, Crafts on Peel helps keep this
            practice visible across generations.
          </p>
